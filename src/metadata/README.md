 ...
 * [dmbao.yml](dmbao.yml)
     * Determines how your purl.obolibrary.org/obo/dmbao/ redirects will be handled
     ...
     * Paste in the contents of [dmbao.yml](dmbao.yml)
 ...
 * [dmbao.md](dmbao.md)
     ...
     * Paste in the contents of [dmbao.md](dmbao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
