...
#	curl -o sources/uberon-bridge-to-aba.owl "https://raw.githubusercontent.com/obophenotype/uberon/master/src/ontology/bridge/uberon-bridge-to-aba.owl"
#	$(ROBOT) convert -i sources/uberon-bridge-to-aba.owl --format owl -o $@
...
## ONTOLOGY: uberon (remove disjoint classes and properties, they are causing inconsistencies when merged with dmba bridge)
.PHONY: mirror-uberon
...
## Disable '--equivalent-classes-allowed asserted-only' due to DMBA inconsistencies
.PHONY: reason_test
